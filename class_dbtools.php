      ...
      public static function optimizeDb()
      {
          ...
          while ($row = Registry::get("Database")->fetchrow($result2)) {
              ...
              if (!$result) {
                  ...
                  $display .= Lang::$word->SYS_DBSTATUS . ' <i class="success icon check" data-content="' . Lang::$word->SYS_DBTABLE . ' ' . $table . ' ' . Lang::$word->SYS_DBREPAIRED . '"></i>';
              }
              $display .= '</td>';
              $display .= '<td>' . $table . '</td>';
              $display .= '<td>';
              ...
              if (!$result) {
                  ...
                  $display .= Lang::$word->SYS_DBSTATUS . ' <i class="success icon check" data-content="' . Lang::$word->SYS_DBTABLE . ' ' . $table . ' ' . Lang::$word->SYS_DBOPTIMIZED . '"></i>';
              }
